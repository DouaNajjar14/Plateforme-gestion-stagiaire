...
export class DepartementListComponent implements OnInit {
  ...
  openEditModal(dept: Departement): void {
    ...
    this.departementResponsable = dept.responsable || '';
  ...
  saveModal(): void {
    ...
    if (this.modalMode === 'create') {
      this.departementService.creer({
        ...
        responsable: this.departementResponsable.trim() || undefined
      }).subscribe({
        next: () => {
      ...
      this.departementService.modifier(this.editingDepartement!.id, {
        nom: this.departementNom.trim(),
        responsable: this.departementResponsable.trim() || undefined
      }).subscribe({
        next: () => {
