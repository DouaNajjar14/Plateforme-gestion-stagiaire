...
public class SpecialiteService {
    ...
    public SpecialiteResponse creer(SpecialiteRequest request) {
        ...
        if (request.getCompetenceIds() != null && !request.getCompetenceIds().isEmpty()) {
            ...
            specialite.setCompetences(new HashSet<>(competences));
        }
    ...
    public SpecialiteResponse modifier(Long id, SpecialiteRequest request) {
        ...
        // Vérifier si le nom est déjà utilisé par une autre spécialité dans le même département
        ...
        if (request.getCompetenceIds() != null) {
            ...
            specialite.getCompetences().clear();
        }
    ...
    private SpecialiteResponse toResponse(Specialite specialite) {
